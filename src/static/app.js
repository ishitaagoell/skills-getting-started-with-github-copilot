                ...
                .map(
                  (participant) => `
                    <li>
                      ...
                      <button class="participant-remove" type="button" data-activity="${encodeURIComponent(name)}" data-participant="${encodeURIComponent(participant)}" aria-label="Remove ${participant}">
                        &times;
                      </button>
                    </li>`
                )
